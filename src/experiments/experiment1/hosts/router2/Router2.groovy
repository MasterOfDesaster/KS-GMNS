...
class Router2 {
    ...
    void receiveFromNeigbor() {
        ...
        while(1) {
            ...
            stillThere=true
            Utils.writeLog("Router2", "empfängt von " + iPAddr, "Routinginformationen", 1)
            ...
            Utils.writeLog("Router2", "schreibt", "neue Routinginformationen", 1)
    ...
    void sendToNeigbors(String rInfo) {
        ...
        for (List neigbor in neighborTable) {
            ...
            Utils.writeLog("Router2", "sendet", "Routinginformationen an: "+neigbor[0]+", "+neigbor[1], 1)
        }
    }
    //------------------------------------------------------------------------------
}
