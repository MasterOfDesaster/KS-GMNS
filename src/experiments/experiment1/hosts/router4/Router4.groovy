...
class Router4 {
    ...
    void receiveFromNeigbor() {
        ...
        while(1) {
            ...
            stillThere=true
            Utils.writeLog("Router4", "empfängt von " + iPAddr, "Routinginformationen", 1)
            ...
            Utils.writeLog("Router4", "schreibt", "neue Routinginformationen", 1)
    ...
    void sendToNeigbors(String rInfo) {
        ...
        for (List neigbor in neighborTable) {
            ...
            Utils.writeLog("Router4", "sendet", "Routinginformationen an: "+neigbor[0]+", "+neigbor[1], 1)
        }
    }
    //------------------------------------------------------------------------------
}
